...
export default function ClaimsPage() {
  ...
  return (
    <div className="bg-[#fafbfb] min-h-screen pb-16 font-sans select-none">
      ...
      <section className="relative w-full h-[280px] sm:h-[340px] bg-[#021f0f] overflow-hidden flex items-center dark-bg pt-24 sm:pt-28 md:pt-36 scroll-mt-28 md:scroll-mt-32">
